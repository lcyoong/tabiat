<template>
    <form class="flex items-start space-x-2" @submit.prevent="createHabit">
      <div class="flex-1">
        <input type="text" v-model="createHabitForm.hab_name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="The habit that might help you to achieve the goal" />
